# Generated by Django 4.0.1 on 2022-09-05 07:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('journal', models.CharField(blank=True, max_length=2000, null=True)),
                ('todoTask', models.CharField(blank=True, max_length=1000, null=True)),
                ('date', models.DateField(auto_now=True)),
                ('postedBy', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'Day',
            },
